...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEmployees({
        relations: ['user', 'organization', 'attendance.count', 'leave.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['job_title.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('attendance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('leave', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'leave',
          header: 'Leave',
          accessorKey: 'leave',
          cell: ({ row: { original: record } }: any) => record?._count?.leave,
        }
      : null,
