  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR management with Test - your ultimate HRMS application for efficiency, accuracy and productivity."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR management with Test - your ultimate HRMS application for efficiency, accuracy and productivity.`}
            </Text>
            <Box
