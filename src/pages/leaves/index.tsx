...
import { getLeaves, deleteLeaveById } from 'apiSdk/leaves';
...
export function LeaveListPage(props: LeaveListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<LeaveInterface>>(
    () => `/leaves?params=${JSON.stringify(params)}`,
    fetcher,
  );
