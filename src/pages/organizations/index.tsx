...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'employee.count', 'job_vacancy.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('employee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('job_vacancy', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'job_vacancy',
          header: 'Job Vacancy',
          accessorKey: 'job_vacancy',
          cell: ({ row: { original: record } }: any) => record?._count?.job_vacancy,
        }
      : null,
