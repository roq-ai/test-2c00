...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'employee.update': {
    roles: ['owner', 'hr-manager', 'administrator'],
    key: 'employee-profile-updated',
    tenantPath: ['organization', 'employee'],
    userPath: [],
  },
  'job_vacancy.create': {
    roles: ['owner', 'hr-manager', 'administrator', 'employee'],
    key: 'new-job-vacancy',
    tenantPath: ['organization', 'job_vacancy'],
    userPath: [],
  },
  'leave.create': {
    roles: ['owner', 'hr-manager', 'administrator'],
    key: 'leave-application',
    tenantPath: ['organization', 'employee', 'leave'],
    userPath: [],
  },
};
